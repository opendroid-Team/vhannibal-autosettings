...
from enigma import RT_HALIGN_LEFT, RT_HALIGN_CENTER, RT_VALIGN_CENTER, eListboxPythonMultiContent, eTimer, gFont, getDesktop
...
class MenuSetting(Screen):
        ...
        def MenuB(self):
                ...
                if not self.DubleClick:
                        ...
                        self.jB.append(self.hauptListEntryMenuB(_('Edit by: OpenDroid Team 2025-20-05'), '', '', '', ''))
